...
export gcycle=$(date +%Y%m%d%H -d "${cycle:0:8} ${cycle:8:2} - ${assim_freq} hours")
export bcycle=$(date +%Y%m%d%H -d "${cycle:0:8} ${cycle:8:2} - ${half_assim_freq} hours")
export PDY=${cycle:0:8}
export cyc=${cycle:8:2}
export YYYY=${cycle:0:4}
export MM=${cycle:4:2}
export DD=${cycle:6:2}
export gPDY=${gcycle:0:8}
export gcyc=${gcycle:8:2}
export bPDY=${bcycle:0:8}
export bcyc=${bcycle:8:2}
export bYYYY=${bcycle:0:4}
export bMM=${bcycle:4:2}
export bDD=${bcycle:6:2}
export CASE="C768"
