...
def bufr_to_ioda(config, logger):
    ...
    tsenqm1 = ma.array(tsenqm1).astype('int32')
    tsenqm1 = ma.masked_values(tsenqm1, tobqmorig1.fill_value)
    tvoqm1 = ma.array(tvoqm1).astype('int32')
    tvoqm1 = ma.masked_values(tvoqm1, tobqmorig1.fill_value)
