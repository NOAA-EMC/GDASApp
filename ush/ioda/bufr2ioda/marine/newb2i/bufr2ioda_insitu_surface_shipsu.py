...
if __name__ == '__main__':
    ...
    config = ShipsuConfig(config_file, logger)
    data = ShipsuData(logger)
    b2i = ShipsuConverter(config, data, logger)
    b2i.run()
    if test_file:
