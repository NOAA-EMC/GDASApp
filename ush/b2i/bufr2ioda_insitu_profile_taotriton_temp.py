...
platform_description = 'TAO/TRITON Tropical mooring profiles from mbuoyb: temperature'


class TaotritonConfig(Bufr2iodaConfig):
    def ioda_filename(self):
        return f"{self.cycle_type}.t{self.hh}z.insitu_profile_taotriton_temp.{self.cycle_datetime}.nc"
