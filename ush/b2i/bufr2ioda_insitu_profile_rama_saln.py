...
platform_description = 'RAMA Tropical mooring profiles from mbuoyb: salinity'


class RamaConfig(Bufr2iodaConfig):
    def ioda_filename(self):
        return f"{self.cycle_type}.t{self.hh}z.insitu_profile_rama_saln.{self.cycle_datetime}.nc"
