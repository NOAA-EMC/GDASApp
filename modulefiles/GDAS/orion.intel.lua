...
setenv("CRTM_FIX","/work2/noaa/da/role-da/CI/GDASApp/fix/crtm/2.4.0")
setenv("GDASAPP_TESTDATA","/work2/noaa/da/role-da/CI/GDASApp/data")
setenv("GDASAPP_UNIT_TEST_DATA_PATH", "/work2/noaa/da/role-da/CI/GDASApp/data/test/")
