...
export GDAS_CI_ROOT=/work2/noaa/da/${USER}/CI/${GDAS_CI_HOST}/GDASApp
...
export AUTHORIZED_USERS_FILE=/work2/noaa/da/role-da/CI/${GDAS_CI_HOST}/GDASApp/authorized_users
