...
namespace gdasapp {
  ...
  class Viirsaod2Ioda : public NetCDFToIodaConverter {
   public:
    ...
    gdasapp::preproc::iodavars::IodaVars providerToIodaVars(const std::string fileName) final {
      ...
      try {
        ...
        gdasapp::preproc::iodavars::IodaVars iodaVars(0, {}, {});
        return iodaVars;
      }
      ...
      gdasapp::preproc::iodavars::IodaVars iodaVars(nobs, {}, {});
