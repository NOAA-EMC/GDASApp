  ...
  class NetCDFToIodaConverter {
   public:
    ...
    void writeToIoda() {
      ...
      gdasapp::preproc::iodavars::IodaVars iodaVars = providerToIodaVars(inputFilenames_[myrank]);
      ...
      gdasapp::preproc::iodavars::IodaVars iodaVarsAll(nobsAll,
   ...
   private:
    ...
    virtual gdasapp::preproc::iodavars::IodaVars providerToIodaVars(
